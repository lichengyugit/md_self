...
class CI_Security {
    ...
    public function __construct() {
        ...
        $this->log->log_trace('加密类实例化 Security Class Initialized');
    }
    ...
    public function csrf_verify() {
        ...
        $this->log->log_info('CSRF token verified');
        return $this;
    }
    ...
    public function csrf_set_cookie() {
        ...
        $this->log->log_info('CRSF cookie sent');
        return $this;
    }
    ...
    public function csrf_show_error() {
        show_error('你的此操作不被允许 The action you have requested is not allowed.', 403);
    }
     ...
     * @param bool $is_image input is an image
     * @return string
     */
     ...
     * @param bool $relative_path preserve paths
     * @return string
     */
