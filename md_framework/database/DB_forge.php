...
abstract class CI_DB_forge {
    ...
    public function __construct(&$db) {
        $this->db = & $db;
        $this->log = & get_log();
        $this->log->log_trace('数据库forge实例化 Database Forge Class Initialized');
    }
     ...
     * 
     * @param string $table
     * @param bool $if_not_exists add IF NOT EXISTS condition
     * @param array $attributes of table attributes
     * @return bool
     */
     ...
     * @param bool $if_exists add an IF EXISTS condition
     * @return bool
     */
     ...
     * Rename Table
     * 
     * @param string $table_name name
     * @param string $new_table_name name
     * @return bool
     */
     ...
     * @param string $table
     * @param array $field
     * @param string $_after AFTER clause (deprecated)
     * @return bool
     */
