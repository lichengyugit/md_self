 ...
 * @package CodeIgniter
 * @author neowei
 * @copyright Copyright (c) 2008 - 2015, integle, Inc.
...
class CI_Profiler {
    ...
    protected $_query_toggle_count = 100;
    protected $CI;
    protected $log;
    ...
    public function __construct($config = array()) {
        ...
        $this->log->log_trace('程序分析实例化 Profiler Class Initialized');
    }
    ...
    protected function _compile_benchmarks() {
        ...
        foreach ($profile as $key=>$val) {
            ...
            $output .= "<tr><td style='padding:5px;width:50%;color:#000;font-weight:bold;background-color:#ddd;'>" . $key . "&nbsp;&nbsp;</td><td style='padding:5px;width:50%;color:#900;font-weight:normal;background-color:#ddd;'>" . ($val * 1000) . "毫秒</td></tr>\n";
        }
    ...
    protected function _compile_queries() {
        ...
        foreach ($dbs as $db) {
            ...
            $output .= "\n";
            $output .= '<legend style="color:#0000FF;">drvier:' . $db->dbdriver . '&nbsp;&nbsp;' . $this->CI->lang->line('profiler_database') . ':&nbsp; ' . $db->database . '&nbsp;&nbsp;&nbsp;' . $this->CI->lang->line('profiler_queries') . ': ' . count($db->queries) . '&nbsp;&nbsp;' . $show_hide_js . '</legend>';
            $output .= "\n";
            ...
            if (count($db->queries) == 0) {
                ...
                foreach ($db->queries as $key=>$val) {
                    ...
                    $output .= "<tr><td style='padding:5px; vertical-align: top;width:4%;color:#900;font-weight:normal;background-color:#ddd;'>" . ($time * 1000) . "毫秒&nbsp;</td><td style='padding:5px; color:#000;font-weight:normal;background-color:#ddd;'>" . $val . "</td></tr>\n";
                }
            }
    ...
    private function highlight_code($str) {
    ...
    protected function _compile_uri_string() {
        ...
        if ($this->CI->uri->uri_string == '') {
            $output .= "<div style='color:#000;font-weight:normal;padding:4px 0 4px 0'>" . $this->CI->lang->line('profiler_no_uri') . "</div><div <div style='color:#000;font-weight:normal;padding:4px 0 4px 0'>URL : " . $this->CI->config->base_url() . '</div>';
        } else {
            $output .= "<div style='color:#000;font-weight:normal;padding:4px 0 4px 0'>" . $this->CI->uri->uri_string . "</div><div <div style='color:#000;font-weight:normal;padding:4px 0 4px 0'>URL : " . $this->CI->config->base_url() . '</div>';
        }
    ...
    protected function _compile_memory_usage() {
        ...
        if (function_exists('memory_get_usage') && ($usage = memory_get_usage()) != '') {
            $output .= "<div style='color:#5a0099;font-weight:normal;padding:4px 0 4px 0'>" . number_format($usage) . ' bytes ' . round($usage / 1024 / 1024, 2) . ' MB</div>';
        } else {
     ...
     */
    public function run() {
        $output = '<html><head><meta charset="utf-8"><title>neolite分析器</title><link rel="icon" href="http://dev.r.integle.com/img/integle.ico"></head><body>';
