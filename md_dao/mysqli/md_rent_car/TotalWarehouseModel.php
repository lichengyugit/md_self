<?php
class TotalWarehouseModel extends Db_Model {
    protected $table=array(
    );

    public function __construct() {
        parent::__construct('md_rent_car','md_total_warehouse');
//        parent::__construct('md_rentcar','md_vehicle');
        $this->log->log_debug('TotalWarehouseModel  model be initialized');
    }
